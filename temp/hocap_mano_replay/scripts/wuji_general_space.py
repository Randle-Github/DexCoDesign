...
DEXCODESIGN_SOURCE = REPO_ROOT / "source" / "dexcodesign"
if str(DEXCODESIGN_SOURCE) not in sys.path:
    sys.path.insert(0, str(DEXCODESIGN_SOURCE))
...
from dexcodesign.morphology.generate import editable_finger_segments  # noqa: E402
